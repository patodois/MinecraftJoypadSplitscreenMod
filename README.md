...
Controller detection and all buttons, sticks, and triggers were verified with an Xbox Wireless Controller over Bluetooth on an Apple Silicon Mac, in Tekxit with Forge 10.13.4.1558. The version also passed 101 simulated input assertions and 19 cursor capture assertions. A successful test was also reported on a **2017 Intel Mac**. Windows still requires hardware testing.
